...
export const Index = () => {
  return (
    <div class="grid">
      <MainSection/>
      <TechChoiceCard title="Javascript"
        icon=<Rabbit/>
      ...
      <TechChoiceCard title="Preact" link="https://preactjs.com/guide/v10/getting-started">
        description of tech choice
      </TechChoiceCard>
      <TechChoiceCard title="Express" link="https://preactjs.com/guide/v10/getting-started">
        description of tech choice
      </TechChoiceCard>
    ...
    edges of your system.
      ...
      <TechChoiceCard title="Litestream" link="https://www.sqlite.org/keyword_index.html">
