...
describe('Phase 1: Integration Tests', () => {
  ...
  test('should serve app with SSR', async () => {
    ...
    assert.ok(html.includes('Minimal Preact starter'), 'Should contain app description');
    assert.ok(html.includes('<script type="module" src="/static/client.js">'), 'Should include client script');
  });
